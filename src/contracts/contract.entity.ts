...
export class Contract {
  ...
  user: User; // Assuming 'contract' is the correct property name in the User entity.

  @ManyToOne(() => ContractAction, contractAction => contractAction.contracts)
  contractAction: ContractAction;

  @ManyToOne(() => AuditLog, auditLog => auditLog.contract)
  auditLog: AuditLog; // Assuming 'contract' is the correct property name in the AuditLog entity.

  @ManyToOne(() => Customer, customer => customer.contract)
  customer: Customer; // Assuming 'contract' is the correct property name in the Customer entity.
